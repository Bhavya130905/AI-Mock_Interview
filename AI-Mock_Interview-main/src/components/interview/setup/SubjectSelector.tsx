      ...
      <div className="grid md:grid-cols-2 gap-5">
        {subjects.map((subject) => (
          <Card
            ...
            className={`cursor-pointer transition-all duration-300 bg-white/5 hover:border-violet-500 hover:shadow-xl hover:shadow-violet-500/20 ${
              selected === subject.id ? "border-violet-500 ring-2 ring-violet-500/50" : "border-white/10"
            }`}
          >
